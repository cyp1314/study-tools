    ...
    <el-table :data="table.data" v-loading="table.loading" border style="width: 100%">
      ...
      <el-table-column prop="type" label="类型" width="110">
        <template #default="scope">
          <el-tag :type="typeTagMap[scope.row.type] || 'info'">{{ typeLabelMap[scope.row.type] || scope.row.type
            }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="amount" label="变更数量" width="200">
        <template #default="scope">
      ...
      <el-table-column prop="balance_after" label="变更后余额" width="200" />
