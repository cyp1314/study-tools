  ...
  <el-card style="margin:10px;">
    ...
    <el-table :data="table.data" v-loading="table.loading" border style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="160">
        <template #default="scope">
          <el-button v-if="scope.row.status === 'pending'" type="success" :link="true"
            @click="handleMarkPaid(scope.row)">确认支付</el-button>
          <el-button v-if="scope.row.status === 'paid'" type="warning" :link="true"
