<template>
  <el-dialog :title="actionType==='add'?'新增产品':'编辑产品'" v-model="visible" width="750px" top="3vh">
    <el-form :model="form" :rules="rules" ref="formRef" label-width="100px">
      ...
      <el-form-item label="提示词前缀" prop="prefix">
        <el-input v-model="form.prefix" type="textarea" :rows="2" placeholder="prefix - 拼接在用户输入前" />
      </el-form-item>
      <el-form-item label="提示词后缀" prop="suffix">
        <el-input v-model="form.suffix" type="textarea" :rows="4" placeholder="suffix - 拼接在用户输入后" />
      </el-form-item>
      <el-row :gutter="20">
        <el-col :span="12">
